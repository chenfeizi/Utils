 ...
 *
 */
public class AutomaticLineView extends ViewGroup{
	...
	private static final int PADDING_HOR = 10;//水平方向padding
	   ...
	   * @param context
	   */
	  public AutomaticLineView(Context context) {
	    super(context);
	  }
	   ...
	   * @param defStyle
	   */
	  public AutomaticLineView(Context context, AttributeSet attrs, int defStyle) {
	   ...
	   * @param attrs
	   */
	  public AutomaticLineView(Context context, AttributeSet attrs) {
	    super(context, attrs);
	  }
