package com.sjq_education.sampsipapp.utils.network_request;
...
public class HttpUtils {
	 ...
	 * @throws Exception 
	 */
	public static Bitmap httpGetBitmap(String url, Map<String, String> params) throws Exception {
		InputStream is = httpGet(url, params);
		if (is == null)
			return null;
	...
	public static String httpPost(final String url,
			Map<String, String> textData, Map<String, File> uploadFiles) throws Exception {
		if (!judgeUrl(url)) {
			throw new NullPointerException("URL 为 null 或空值");
		}
